...
if ( 'ok' === $licence_status ) {
	...
	$status_box = [
		'color' => '#e17622',
		'icon'  => 'warning',
		'text'  => __( '認証URLをメールアドレスへ送信しました。3分以内にURLへアクセスしてください。<br>認証完了後、下の「アクティベートを完了」ボタンを押してください。', 'swell' ),
	];
	$submit_btn = [
		'val'   => 'check',
		'class' => 'primary',
	...
	$help = '<p>' . __( '※ ３分を過ぎてリンクの期限が切れてしまった場合は、一度画面を更新して認証リクエストを再送信してください。', 'swell' ) . '</p>';
